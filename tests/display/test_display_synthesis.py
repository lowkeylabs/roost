...
def test_aggregate_display_fields_registered(
    ...
    assert reg.has_display_field("timing.elapsed_seconds__median")

    assert reg.has_display_field("timing.elapsed_seconds__p90")
...
def test_aggregate_display_field_has_profiles(
    ...
    field = reg.get_display_field("timing.elapsed_seconds__median")
