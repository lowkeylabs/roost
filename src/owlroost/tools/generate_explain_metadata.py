...
# ---------------------------------------------
# Assumes PARAMETERS.md file has already been
# copied into src/owlroost/schema/generated by the
# sync_owl_parameters_md.py script.
#
# Can be adjusted later if needed.
# ---------------------------------------------

OWL_PARAMETERS_MD = OUTPUT_DIR / "PARAMETERS.md"
